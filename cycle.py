...
class CycleGAN():
    ...
    def __init__(self,args,GAB,GBA,DA,DB,tokenizer) -> None:
        ...
        self.optimizer_G_AB = Adafactor(self.G_AB.parameters(), lr = args.G_lr ,scale_parameter=False, relative_step=True , warmup_init=True,clip_threshold=1,beta1=0,eps=( 1e-30,0.001))
        self.optimizer_G_BA = Adafactor(self.G_BA.parameters(), lr = args.G_lr ,scale_parameter=False, relative_step=True , warmup_init=True,clip_threshold=1,beta1=0,eps=( 1e-30,0.001))
        self.optimizer_D_A = Adafactor(self.D_A.parameters(), lr = args.D_lr ,scale_parameter=False, relative_step=True , warmup_init=True,clip_threshold=1,beta1=0,eps=( 1e-30,0.001))
        self.optimizer_D_B = Adafactor(self.D_B.parameters(), lr = args.D_lr ,scale_parameter=False, relative_step=True , warmup_init=True,clip_threshold=1,beta1=0,eps=( 1e-30,0.001))
